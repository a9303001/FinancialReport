...
| **5** | 一線房價**近 40 個月**趨勢 | §7 → 第六章 | 40 列資料表 ＋ 摘要表 ＋ 文字判讀 |
| **6** ⭐ | 一線**租金近 60 個月**趨勢 ＋ **5 個月復甦規則** | §8 → 第七章 | 60 列資料表 ＋ 摘要表 ＋ **5 個月規則判定表** ＋ 文字判讀 |
...
| **趨勢折線圖（mermaid／ASCII 等任何圖表）** | 不產生額外判斷；資料表 ＋ 摘要表 ＋ 文字判讀已足夠，且圖表易失真、耗預算 |
...
### 7.5 判讀（必寫，每點有數字，**不需繪製趨勢圖，以文字與表格呈現即可**）
...
### 8.5 判讀（必寫，每點有數字，**不需繪製趨勢圖，以文字與表格呈現即可**）
...
- [ ] 第六章有完整 **40 列**表 ＋ 摘要表 ＋ 文字判讀結論？
- [ ] **第七章有完整 60 列租金表 ＋ 5 個月規則逐城判定表 ＋ 強制結論行 ＋ 文字判讀**？
...
## 七、一線租金近 60 個月趨勢 ＋ 5 個月復甦規則【項目 6】⭐
   ...
   7.6 判讀 ＋ 🟢 利多 ／ 🔴 風險（須含季節性假訊號情境；文字結論，不需趨勢圖）
...
- 交付：✅ 八項全覆蓋｜✅ 40 列＋60 列資料表｜✅ 5 個月規則已連動燈號｜✅ 每單位化｜✅ 全文重寫
- Git：✅ 已 push master
```
