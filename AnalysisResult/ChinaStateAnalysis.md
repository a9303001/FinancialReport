...
### 2.2 香港樓市與利率傳導指標
1. **中原城市領先指數（CCL, Centa-City Leading Index）**：
   - 反映香港二手住宅樓價的即時週頻指數，是香港樓市最權威的領先指標。基準點為 1997 年 7 月的 100 點。
2. **差餉物業估價署指數（RVD Index）**：
   - 香港特區政府官方發布的住宅售價與租金指數，屬月頻官方權威數據，但落後 CCL 約 1~2 個月。
3. **Fed 利率傳導鏈**：
   - `美聯儲 Fed 升降息` → `香港金管局貼現窗調整` → `銀行同業拆息 HIBOR / 最優惠利率 Prime Rate 變動` → `民眾房貸每月供款增減` → `買方負擔能力與樓市成交量`。
4. **撤辣（Removal of Property Cooling Measures）**：
   - 香港特區政府全面取消買家印花稅（BSD）、新住宅印花稅（NRSD）及額外印花稅（SSD），大幅降低非本地買家與投資客的入市交易成本。
