...
> **這份規格要做什麼**：定期產出一份「**能不能買、敢不敢抱**持有中國內地物業的港股 REIT」的決策依據報告。
> **主結果檔**：`AnalysisResult/ChinaStateAnalysisResult.md`（每輪**全文重寫**，不是往後追加）。
> **強制遵守**：`AGENTS.md`（個股分析規則、REIT 分析規則、每股化、利多風險並重、中文回覆）。
> **讀者設定**：**入行 1～2 年的初級股票分析師**。看不懂的名詞第一次出現要附英文並用一句白話解釋，能用表格就不要寫成長篇文章。
> **分析標的（只做個別 REIT，不做 REIT ETF）**：`01426` 春泉產業信託（Spring REIT）、`87001` 匯賢產業信託（Hui Xian REIT）。其他持有中國物業的港股 REIT（如 `00405` 越秀房託）列為對照組。

---

## 0. 三分鐘導讀：這份報告只回答 4 個問題

| # | 要回答的問題 | 為什麼這題會決定 REIT 賺不賺錢 | 產出章節 |
|:--:|---|---|:--:|
| 1 | **中國未來三年（2026–2028）房地產景氣往哪走？** | 房地產鏈約占中國 GDP 與地方財政 20%～25%。景氣決定租客（企業）敢不敢擴張、敢不敢續租，最後決定 REIT 的租金。 | 第 3 章 |
| 2 | **百城 / 國房景氣指標現在幾度？** | 這是「房市體溫計」。指標轉折通常**領先** REIT 的租金與估值 2～4 個季度，是最早的預警訊號。 | 第 4 章 |
| 3 | **一線城市（北上廣深）景氣如何？** | 兩檔標的的核心資產都在**北京**。全國均值對它們沒有意義，一線（甚至一線的某個 CBD）才有意義。 | 第 5 章 |
| 4 | **REIT 手上的物件到期後怎麼辦？** | 中國土地是**有年限的**。到期怎麼處理，直接決定「這檔 REIT 的資產最後值不值錢、還是歸零」。**這是本報告的最重點。** | 第 6 章 |

> **一句話心法**：買美國、日本的 REIT，你買的是「永久產權（Freehold）＋租金」；買中國物業的港股 REIT，你買的是「**一段有到期日的現金流**」。所以看到 8%～12% 的高殖利率，第一個要問的不是「配息穩不穩」，而是「**這筆錢是租金，還是在退還你的本金？**」

---

## 1. 不可違反的鐵則（Invariants）
...
|:--:|---|---|---|---|
| 1 | **百城價格指數**（百城住宅價格指數，China Index Academy 100-City Index） | 中指研究院／**每月月初**發布上月 | 新房均價受建商促銷干擾；**二手房均價才是真實供需**。看「環比%」與「幾漲幾跌（漲跌城市家數）」 | 房價 → 財富效應 → 商場消費 → 零售租金 |
| 2 | **國房景氣指數**（房地產開發景氣指數，Real Estate Climate Index） | NBS／每月與開發投資同步 | 2012 = 100。**95～105＝適度景氣；>105＝過熱；<95＝偏冷**。長期低於 95 代表開發端仍在收縮 | 開發端收縮 → 地方財政緊 → 招商與新增供給節奏 |
| 3 | **NBS 70 城房價指數** | NBS／每月中旬（2026 年起改以 **2025 年為基期**） | 分「新建商品住宅」與「二手住宅」，各有環比／同比 | 逐城拆解一線的唯一官方權威來源 |
| 4 | **開發投資 / 銷售面積 年增率** | NBS／每月 | 判斷是「L 型築底」還是「續探」 | 決定三年展望的主基調 |
| 5 | **二手房成交量（套數）** | 各地房管局／中原、貝殼 | **量先於價**：成交量回升通常領先房價 1～2 季 | 最早的落底訊號 |
| 6 | **甲級寫字樓空置率（Vacancy Rate）** | 高力（Colliers）／戴德梁行／世邦魏理仕 | 北京、上海 CBD 已在 15%～20%+；深圳部分逾 25% | **直接**決定 REIT 的出租率與議價能力 |
| 7 | **續租租金調整率（Rental Reversion）** | REIT 財報／仲介行 | 舊租約到期換新租約，租金是漲還是跌。目前多為 **−5% ～ −20%**，且要送 3～6 個月免租期 | 這是 REIT 收入衰退的**主因**，比空置率更痛 |
| 8 | **租售比 / 資本化率（Rental Yield / Cap Rate）** | 自行計算：年租金 ÷ 物業價格 | 住宅租售比回到 2.5%～3.5% 時，長租買盤會進場撐住價格底 | 估值師定 Cap Rate → 直接影響 NAV |
...
### 4.3 判讀原則（初級分析師最容易搞混的地方）

- **新房漲、二手跌 ≠ 市場回暖**：新房均價常因「高總價的核心區案量占比上升（結構效應）」被拉高，二手跌才是真實需求在退。**兩者背離時，以二手為準。**
- **看「漲跌城市家數」比看均價重要**：92:8 這種懸殊比，代表這是**全國性下行**，只有極少數核心城市例外。
- **租金同比為負（−2.62%）的訊號**：租金是不動產的「本業收入」。**房價可以靠政策撐，租金撐不了**——租金續跌代表 REIT 的收入端沒有支撐。
- **國房景氣指數長期低於 95**：代表開發商仍在收縮，未來 2～3 年新增供給會減少（中期利多），但短期代表投資與拿地意願仍弱（短期利空）。

---

## 5. 主題三：一線城市房地產景氣（北上廣深）

**為什麼單獨拉一章**：兩檔標的的核心資產都在**北京**（春泉＝北京華貿中心寫字樓；匯賢＝北京東方廣場）。**北京 CBD 的甲級寫字樓景氣，就是這兩檔的損益表。**

### 5.1 住宅面（來源：NBS 70 城原始頁，必須回官網核對，不可抄二手摘要）
...
## 6. 主題四（最重點）：REIT 物件「到期」後的後續處理方式

### 6.1 先建立觀念：中國物業 REIT 是「有終點的現金流」
...
- **地方前例（可作為推估錨點）**：深圳 2004 年《到期房地產續期規定》——不改變用途者續期，**補繳地價約為公告基準地價的 35%**，一次性支付。分析時可用此比例做敏感度測試，但**必須標示 `(估)` 並說明是類比地方前例**。
- **估值報告的陷阱**：多數估值師在報告中**明文假設「毋須再支付額外土地出讓金」**（春泉即為一例）。也就是說——**續期成本根本沒有被反映在 NAV 裡**。你看到的每單位淨值，是「假設不用補錢」的樂觀版本。

### 6.3 到期的五條出路（每一條都要算成「每單位多少錢」）
...
- **分析結論的正確講法**：「P/NAV 打一二折」是**假便宜**，因為 NAV 裡近九成會歸零；真正屬於投資人的終值必須用「清算條款可回收的部分」重算，再折現。
...
```
並用 ①②③ 跑三情境（**續期成功／無法續期／提前處分**），做出**每單位價值區間**，最後與**現價**比較，明確回答：**現價到底貴還是便宜。**

### 6.6 「到期倒數」檢查清單（每輪逐項打勾）
...
```mermaid
flowchart TD
    A[1 讀舊結果檔，找出本輪要更新什麼] --> B[2 中國三年景氣：官方數據+機構預測+房企債務]
    B --> C[3 百城 / 國房景氣指標更新與判讀]
    C --> D[4 一線城市住宅與商辦逐城拆解]
    D --> E[5 REIT 到期處理方式精算：A~E 五條出路 + 三公式]
    E --> F[6 其他五大風險數字更新]
    F --> G[7 多平台輿情蒐集與真偽過濾]
...
**Step 2～4**：對應第 3、4、5 章，**所有官方數據一律回官網原始頁核對**，禁止只採信媒體摘要。
**Step 5**：先讀本機資料再上網——`01426春泉Reit/`、`87001匯賢Reit/` 內有年報、中期業績公告與既有分析檔，**優先使用**（零延遲、資料完整）；不足再上 HKEXnews／公司 IR。
**Step 6**：把第 7 章 5 個風險的數字全部更新，全部每單位化。
...
- [ ] 每章都有 🟢 利多 與 🔴 風險？
- [ ] 未證實傳言都標記了？
- [ ] **第 6 章的三個公式都跑出實際數字、給出每單位價值區間並與現價比較了？**
- [ ] 資料逾 6 個月標 `(舊)`、推估標 `(估)`、查無標 `N/A`？

---

## 9. 結果檔骨架（`AnalysisResult/ChinaStateAnalysisResult.md`）

```markdown
# 中國房地產景氣 × 港股中國物業 REIT 投資判斷

> 更新時間：YYYY-MM-DD hh:mm:ss（第 X 輪）
> 分析範圍：中國三年景氣｜百城與國房景氣指標｜一線城市｜REIT 物件到期處理
> 基準匯率：HKD/RMB = X.XXXX｜USD/HKD = X.XXXX（取價日：YYYY-MM-DD）
> 讀者：初級股票分析師

## 一、30 秒執行摘要（表格：主題 / 一句話結論 / 信心度 / 較上輪變化 / 依據）
## 二、與上一輪的結論異動（含「數據修正」要標 🔧）
## 三、資料取得狀態（項目 / 取得與否 / 來源 / 日期 / 缺漏原因）

## 四、中國房地產未來三年景氣（2026–2028）
  4.1 總體走勢判斷（L 型／修復／下探，含機率）
  4.2 機構預測彙整表（Fitch / UBS / Goldman / Reuters）
  4.3 房企債務進度（萬科、碧桂園、恒大）
  4.4 政策與傳言真偽核實
  4.5 🟢 利多 Top 3 ／ 🔴 風險 Top 3

## 五、百城與國房景氣指標
  5.1 指標總表（新房／二手／漲跌家數／租金／國房景氣指數）
  5.2 判讀：新房與二手背離代表什麼、租金為何是關鍵
  5.3 對 REIT 的傳導路徑與時間差

## 六、一線城市房地產景氣
  6.1 北上廣深住宅逐城表（NBS 原始頁）
  6.2 一線商辦表（空置率／租金／新增供給），北京 CBD 為重點
  6.3 城市內部分化與老破小、收儲互動
  6.4 🟢 利多 ／ 🔴 風險

## 七、REIT 物件到期後續處理方式（核心章）
  7.1 中國土地年限制度與 NAV 剛性下折
  7.2 法律現況：民法典 359 條與非住宅細則空白、深圳 35% 前例
  7.3 五條出路 A~E 對照表
  7.4 87001 匯賢：2049 無償移交時間軸、每單位年折減、清算可回收終值
  7.5 01426 春泉：2048 惠州／2053 北京、續期成本每單位試算、極端情境現金底
  7.6 三情境每單位價值區間 vs 現價（**買賣結論寫在這裡**）
  7.7 到期倒數檢查清單結果

## 八、其他五大風險數字更新（商辦通縮／幣別利率／LTV／預扣稅／治理）
## 九、社群輿情整理（平台 / 風向 / 多空 / 查證評估）
## 十、⚠️ 待查與資料缺口
## 十一、結論與投資建議（3 點）＋ 免責聲明
## 十二、下一輪追蹤項目與數據發布時程
```
...
- 一線城市：二手環比最強 <城市>（+X.X%）｜北京 CBD 空置率 XX.X%
- REIT 到期精算：
...
- 每單位價值區間 vs 現價結論：<高估／合理／低估>
- 與上輪異動：X 項強化、Y 項修正｜主結果檔已覆寫
- 自檢：說人話 ✅｜每單位化 ✅｜利多風險並重 ✅｜傳言查證 ✅｜到期章三公式 ✅
```
