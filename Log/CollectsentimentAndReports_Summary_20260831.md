...
| `8433 弘帆` | 股市爆料同學會 (CMoney API)、鉅亨網 Anue、MoneyDJ、公開資訊觀測站、PTT、雪球 | `202608_輿情新聞.md` | ✅ 輿情與新聞更新成功（收錄 2026/08/07 董事會通過半年報 EPS 2.79 元、5~7月營收年月雙增、股東常會配息 4.2 元、外銷匯率受惠與三率提升等實質討論） |
...
- **來源**: 格隆匯 (Gelonghui) / 雪球 (Xueqiu) 針對 2832 台產與 8433 弘帆搜尋
  - **原因**: 搜尋 2832 台產 / 8433 弘帆 無個股專屬深度討論文章
  - **已依 §2 換過的 MCP**: Bright Data / Firecrawl，確認回傳為通用產業觀點或無符合個股專欄，已依 §5.4 誠實記錄於各公司輿情檔中。
...
| :--- | :--- | :--- |
| **SEC EDGAR MCP** | `get_cik_by_ticker`<br>`get_company_info`<br>`get_recent_filings`<br>`analyze_8k` | 查詢 Toyota Motor Corp（TM）與 Universal Health Services（UHS, CIK: 0000352915）最新 10-K、10-Q、8-K（Q2 財報、優先票據融資）申報紀錄，完成 Phase 2 財報檢核。 |
