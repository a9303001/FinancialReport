...
> **更新紀錄與時間戳記：**
> - **本次分析時間**：2026-07-16（**第 17 輪**，**本輪有實質新資訊**，取得官方年報一手數據關閉 ROE 估算缺口）
> - **本輪性質**：直接下載並解析春泉 2022 年報（`2023042400937.pdf`）與 2023 年報（`2024042401750.pdf`）之審計財務報表原文（firecrawl 遠端解析多次逾時，改用本機 Python/pdfminer 下載後離線解析成功），取得 2021-2023 三年**官方**單位持有人應佔溢利與期末權益數字，**首次以一手數據取代先前 FX 反推之 ROE 估算值**：2021 +7.64%／2022 +0.43%／2023 -1.27%（原估算為 +6.9%／+0.4%／-1.2%，2022-2023 誤差 <0.05pp 印證原估算法可靠，2021 略高 0.7pp）。過程中亦交叉核對 NAV/單位 5 年趨勢（5.56→4.95→4.70→4.36→4.14 港元）之官方數字，**確認原有數據皆正確、無需修正**。
> - **🆕 本輪關鍵確認（第 17 輪，截至 2026-07-16）**：
>   1. **官方年報一手 ROE 數據**（信心層級：高——直接取自審計財務報表）：2021 年單位持有人應佔溢利 RMB 509,950 千元／期末權益 RMB 6,671,653 千元；2022 年溢利 RMB 28,352 千元／期末權益 RMB 6,558,843 千元；2023 年虧損 RMB (77,544) 千元／期末權益 RMB 6,130,664 千元。詳見「關鍵財務與估值數據表」ROE 列。
>   2. **NAV/單位交叉驗證**：2021 年報／2022 年報／2023 年報之期末 NAV/單位（RMB／HK$）逐年數字與現有報告「NAV/單位 5 年趨勢」列完全吻合，確認先前各輪數據無誤。
> - **📌 前一輪（第 16 輪）關鍵確認（保留摘要）**：查得四川遂寧市 2026/3 印發全國首個系統性商工用地續期操作指南，補強 Q1「其它案例」子問題（詳見 Q1 第 2 節）；北京自身仍無一般到期續期細則，此缺口依然存在。
...
> - **分析基準**：2025 年年報（`2026042200516.md`）、2024 年年報（`2025042201223.md`）、2013 上市文件（`ltn20131205481.md`）、2026 Q1 營運統計、本地輿情（截至 2026/6/26）+ 2022/2023 年報審計財務報表（`2023042400937.pdf`／`2024042401750.pdf`）+ 第 6-17 輪網路搜尋（截至 2026/7/16，含 Mercuria 官方 2026Q1 投資人簡報、四川遂寧續期指南）
> - **下一輪比對基準**：本檔案「最新結論摘要」表格與 Q1/Q2 情境預測；追蹤 2026 H1 業績公布日期與實績（預期 2026/8）、北京供給消化（尤其 CBD 子市場 H2 新增供給落地情況）、香港 REITs 修例草案是否正式提交、Mercuria/Fang Chao/PAG 是否有新表態或 DI 異動、Mercuria 下季（2026Q2）投資人簡報是否更新春泉評估值/市場評價落差數字、北京是否比照遂寧模式出台一般到期續期細則、補齊 FY2020 及更早年份官方 ROE 數據以延伸歷史序列
...
**✅ 第 17 輪重點成果（本輪，有實質新資訊）**：下載並離線解析春泉 2022/2023 年報審計財務報表原文，取得 2021-2023 官方一手 ROE 數字（+7.64%／+0.43%／-1.27%），關閉先前估算值缺口，並交叉驗證確認既有 NAV/單位 5 年趨勢數據無誤。**下一輪待辦**：如有餘力可補齊 FY2020 及更早年份官方數字延伸歷史序列（非優先）。
