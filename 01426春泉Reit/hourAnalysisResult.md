...
> **更新紀錄與時間戳記：**
> - **本次分析時間**：2026-07-15（滾動確認輪，**第 10 輪**，與第 6-9 輪同日之延續確認輪）
> - **本輪性質**：核心投資論點**無實質變化**（土地到期風險、DPU 回升時間線與情境機率全數維持）。本輪重點為**關閉兩項長期資料缺口**（CBRE 北京數據、FY2016/2017/2020 DPU 歷史數字），並新增**大股東 Mercuria Holdings 因春泉股價下跌而認列虧損**之交叉驗證證據。
> - **🆕 本輪關鍵更新（第 10 輪）**：
...
> - **分析基準**：2025 年年報（`2026042200516.md`）、2024 年年報（`2025042201223.md`）、2013 上市文件（`ltn20131205481.md`）、2026 Q1 營運統計、本地輿情（截至 2026/6/26）+ 第 6-10 輪網路搜尋（截至 2026/7/15）
> - **下一輪比對基準**：本檔案「最新結論摘要」表格與 Q1/Q2 情境預測；追蹤 2026 H1 業績公布日期與實績、北京供給消化（尤其 CBD 子市場）、香港 REITs 修例草案是否正式提交、Mercuria/Fang Chao/PAG 是否有新表態或 DI 異動
