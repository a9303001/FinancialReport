...
> **更新紀錄與時間戳記：**
> - **本次分析時間**：2026-07-16（**第 19 輪**，延續第 15-18 輪之一手數據補強計畫）
> - **本輪性質**：小幅補充——利用第 18 輪已下載之 2017 年報分派總結表（原表格亦含 FY2014/2015 明細），將 10 年 CAGR 所用之 FY2015 DPU 來源由「部落格二手引用」升級為官方年報一手數字（金額不變，26.6 港仙）。**本報告資料品質相關缺口至此已無剩餘可透過現有工具與公開資料進一步關閉的項目**，後續輪次應轉為「觸發式」查證（等待 2026H1 業績、Mercuria Q2 簡報等外部事件），不宜再逐輪深挖既有議題以避免內容稀釋。
...
> - **分析基準**：2025 年年報（`2026042200516.md`）、2024 年年報（`2025042201223.md`）、2013 上市文件（`ltn20131205481.md`）、2026 Q1 營運統計、本地輿情（截至 2026/6/26）+ 2016-2023 各年年報原始 PDF（分派總結表與審計財務報表）+ 第 6-19 輪網路搜尋（截至 2026/7/16，含 Mercuria 官方 2026Q1 投資人簡報、四川遂寧續期指南）
