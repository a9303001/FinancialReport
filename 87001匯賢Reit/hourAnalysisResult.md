...
> **更新紀錄與時間戳記：**
> - **本次更新時間**：2026-07-14 12:06（延續 2026-07-14 稍早分析基準，同日滾動更新）
> - **前一輪分析基準**：2026-07-14（12:02 前版本）
> - **本輪更新重點（本輪為「無重大變化」確認輪，數據細節略有補強）**：
>   1. **股價與估值持平**：最新可查得收盤價約 **RMB 0.385–0.39**（區間內小幅波動，無明顯趨勢變化），與前輪 0.385 相近，P/NAV 折讓維持約 **87–88%** 區間，未見顯著變化。
>   2. **仍無 2026 年中期業績公告**：官方公告清單（huixianreit.com）確認最新申報僅至 **2026/7/2 例行月報表**，尚無中期業績公告，符合「約 8 月上旬公布」的歷史慣例預期，資料缺口延續、非資料庫延遲所致。
>   3. **土地續期政策細節本輪再補強（量化公式出爐，但適用範圍判斷不變）**：查證到廣州、深圳兩地已將續期規則量化為具體公式——
>      - **廣州**：達標產業用地續期費用 = (續期年期 ÷ 法定最高出讓年限) × 基準地價 × 用地面積 × 70%，最長可續期 20 年；不達標用地則按 100% 基準地價計算，最長續期 5–10 年。
>      - **深圳**：允許工業用地申請 REITs 後，將土地使用權人變更為全資項目公司，原土地供應合同之用途與產權限制條件維持不變；出讓年限最長 30 年，租賃期年租金按「20 年期出讓市場價格的 3%」計算。
>      - 惟兩地新規範對象**仍為一般產業/工業用地使用權人**，條文**未涉及涉外土地使用權或中外合作經營企業土地**的特殊處理，北京東方廣場《中外合作經營合約》「合營期滿固定資產無償移交中方」的特別約定仍不在明確適用範圍內，維持「潛在利多監測項目、尚無法量化」的判斷，僅政策細則的量化程度較前輪更清晰，供後續比對北京/東方廣場是否比照辦理之基準。
>   4. **匯率背景微幅更新**：即期 USD/CNY 最新約 **6.77–6.81**（一週高點 6.806、低點 6.775），較前輪 6.78 大致持平，2026 年迄今均值約 6.866，人民幣兌美元呈溫和升值格局；對 24 年後清算價值估算的方向性結論不變（僅供參考）。
>   5. **本輪社群輿情掃描未發現新增討論**：雪球、PTT／股市爆料同學會等平台搜尋未見與 87001 或北京東方廣場直接相關之新討論串，反映此檔仍屬低關注度、低流動性標的，市場氛圍與前輪一致。
>   6. **GitHub 本地資料夾與核心基本面數據無變化**：流通基金單位數（6,523,199,235，2026/6/30 確認不變）、負債結構、物業出租率、4/27 貸款償還後總負債估算（約 RMB 43.4 億）等核心數據維持前輪結論，持續有效。
...
1. **清算價值角度**：北京東方廣場於 2049 年合營期滿清算時，預計每基金單位可回收金額約 **RMB 0.95 至 1.36 元**，相比目前 RMB 0.385–0.39 的股價存在 **140% 以上的超額清算溢價**。
...
| :--- | :---: | :---: | :--- |
| **最新股價** | - | **約 0.385–0.39 元** | HKEX / 東方財富 / Yahoo Finance（2026年7月上旬區間，無明顯趨勢變化） |
| **已發行基金單位** | - | **6,523,199,235** | HKEX 月報表（截至2026年6月30日確認無變動，無稀釋風險） |
| **最新總市值** | 約 25.1–25.4 億元 | 0.385–0.39 元 | 計算值 (股價 × 單位數) |
| **每基金單位資產淨值 (NAV)** | 207.03 億元 | **3.1737 元** | 2025 年年報 |
| **股價淨值比 (P/NAV)** | - | **約 0.121–0.123** (折讓約 87–88%) | 計算值 (股價 / 3.1737) |
...
| **最新股息殖利率 (Yield，TTM)** | - | **約 1.10–1.12%** | 計算值 (0.0043 / 股價) |
...
| **USD/CNY 即期匯率** | - | - | 約 6.77–6.81（2026年7月上旬區間，2026年迄今均值 6.866） |
...
1.  **退還註冊資本**：全額退還滙賢投資出資的 **6 億美元** 註冊資本（依現行匯率約 6.78 折算約 **RMB 40.7 億元**，較先前以 7.0 匯率估算的 42 億元略低）。
...
*   **結論**：相較於目前 **RMB 0.385–0.39** 的股價，不論何種情境，均有 **135% 至 245%** 的清算溢價（本輪因現行匯率略低於前次假設值，估算金額微幅下修，但結論方向不變）。
...
### 5. 監測中：全國性商業用地續期政策動向（本輪更新：量化公式出爐）
...
*   **地方細則持續加速落地，本輪查證到具體量化公式**：
    - **北京**：已於 2025 年發布工商業用地續期一般性規則——續期年限與剩餘年限之和不超過法定最高年限；續期地價可按「首次出讓時地價水平」或「續期時基準地價」重新綜合評估；《北京市 2026 年度建設用地供應計劃》進一步「試點工商業用地使用權續期」。
    - **廣州（本輪新增量化公式）**：達標產業用地續期費用 = **(續期年期 ÷ 法定最高出讓年限) × 基準地價 × 用地面積 × 70%**，最長續期 20 年；不達標用地則按 100% 基準地價計算，續期年限縮短為 5–10 年。
    - **深圳（本輪新增）**：允許工業用地申請 REITs 發行後，將土地使用權人變更為全資項目公司，原土地供應合同之用途與產權限制條件維持不變；出讓年限最長 30 年，租賃期年租金按「20 年期出讓市場價格的 3%」計算——此為針對「REITs 底層資產」續期/確權問題的直接政策回應，性質上與匯賢（境外上市 REIT 持有境內中外合作經營資產）情境相近，值得後續持續追蹤是否有更多城市跟進、是否擴及外資 REIT 底層資產。
...
*   **量化影響**：官方公告以2025年H1可分派金額為基準說明，此匯兌虧損**相當於2025H1可分派金額的約438%**——換算每單位負面影響約 **RMB 0.0067 元**（已超越2025全年DPU 0.0043元的1.5倍），意味著 **2026H1 期中DPU大概率趨近於零，甚至不排除暫停期中分派**（實際結果仍待H1業績公告確認；截至本輪查證，官方尚未公告中期業績日期，僅按歷史慣例預期約8月上旬）。
...
4.  **土地續期政策落地速度快於預期（本輪強化觀察）**：深圳已針對「REITs 底層工業用地」到期問題推出具體續期方案，顯示監管機關開始正視 REITs 資產到期的結構性風險，方向上對匯賢屬長期潛在利多，惟現行細則尚未涵蓋涉外/中外合作項目。
...
*   **本輪網路搜尋與比對**：
    - 股價與市值：Yahoo Finance、東方財富（quote.eastmoney.com）、鉅亨網（cnyes.com）等平台查證（2026年7月上旬，收盤約 RMB 0.385–0.39，區間內無明顯趨勢）。
    - 官方公告清單（本輪重新查證）：huixianreit.com/cht/investor/ — 確認最新公告為 2026/7/2 月報表，尚無中期業績公告；4/27「償還貸款及其財務影響」公告仍為最新一筆重大財務事件公告。
    - 全國性商業用地續期政策背景：新京報（bjnews.com.cn）2024年7月21日中共中央決定報導；東方財富財富號（caifuhao.eastmoney.com）2026年4月/5月「涉及REITs土地續期」及「一線城市土地續期答案」二文，提供廣州、深圳量化續期公式（本輪新增細節來源）。
    - 人民幣匯率背景：exchangerates.org.uk、投資網站彙整 2026年7月USD/CNY歷史數據（區間 6.775–6.806，2026年迄今均值 6.866）。
    - 社群輿情掃描：雪球（xueqiu.com/S/87001）、PTT／股市爆料同學會關鍵字搜尋，本輪未發現與87001直接相關之新討論。
*   **本輪查證但未發現新增本地資料**：GitHub本地87001匯賢Reit資料夾內既有歷史檔案（年報x3、中期報告x1、輿情/雪球節錄x4：2026-00-12.md、2026-02-11.md、2026-06-16.md、Analysis-stock-report_20260615.md）均已於歷輪分析中納入，本輪未發現新增或更新檔案。
